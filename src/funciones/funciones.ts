...
/** Función que sustituye las variables del spanEmbed de quill con datos dinámicos
 * @param {data} Object Objeto con toda la información de las variables del SpanEmbed
 * @return {string}
 */
